						...
						<fieldset>
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<label for="familia_casa">
										<spam class="glyphicon glyphicon-asterisk requerido"></spam>Familia
									</label>
									<input type="text" placeholder="Perez Garcia" id="familia_casa">
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<label for="telefono_casa">Teléfono</label>
						...
						<fieldset>
							...
							<div class="row">
								<div class="col-xs-4 col-xs-offset-8 col-sm-4 col-sm-offset-8 col-md-4 col-md-offset-8 col-lg-4 col-lg-offset-8">
									<label>
										<input type="button" value="Guardar" class="btn-lg btn-azul derecha" id="enviar_datos"/>
									</label>
								</div>
							</div>
						</fieldset>
		...
		<script type="text/javascript" src="js/registrar_casa.js"></script>