				...
				<div class="row">
					<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xs-offset-2 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
						<fieldset>
							...
							<form class="form-vertical" id="frmcat" name="frmcat" action="index.php/administrador/registrar_categoria" method="POST" enctype="multipart/form-data">
								<div class="row">
								...
								<div class="col-xs-4 col-xs-offset-8 col-sm-4 col-sm-offset-8 col-md-4 col-md-offset-8 col-lg-4 col-lg-offset-8">
									<label>
										<button type="button" class="btn-lg btn-azul derecha" id="enviar_categoria">Registrar Categoria</button>
								</div>
							</div>
							</form>							
						</fieldset>
