		<nav>
			<div class="container">
				<ul class="navbar izquierda">
 					...
 					<li><a href="<?php echo site_url('presidente/miembros'); ?>">Miembros</a></li>
 				</ul>
					...
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
						<fieldset class="panel">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<label for="puesto">
										<spam class="glyphicon glyphicon-asterisk requerido"></spam>Puesto
									</label>
									<select id="puesto">
		...
		<script type="text/javascript" src="js/registrar_miembro.js"></script>