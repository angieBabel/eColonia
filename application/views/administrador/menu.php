				...
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
						<fieldset class="menu" id="estructural">
							<center>
								<form id="form_estructura" action="<?php echo site_url('administrador/estructura'); ?>" method="POST">
					...
					<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
						<fieldset class="menu" >
							<center>
								<form aid="form_estructura" action="<?php echo site_url('administrador/gestion'); ?>" method="POST">
